...
<body id="body" background="">
    <div class="jumbotron jumbotron-fluid text-center bg-dark pb-2 pt-3">
        <h1 class=" display-3 text-light pt-0">E - BOOKS</h1>
        <hr class="m-2 ">
    ...
    <div class="container border shadow-lg rounded p-4 py-5 mb-5 bg-light" style="max-width: 350px;">
        <form target="_self" method="post" action="">
            ...
            <label for="text" class="ml-1">Chief's name:</label>
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="Admin_name" placeholder="id">
            </div>
            
            <label for="password" class="ml-1">Entry code:</label>
            ...
            <div class="">
              ...
              if(isset($_POST['submit']))
               ...
               <button name="submit" class="p-2 btn btn-block  btn-outline-danger" style="background-color:; border:" value="SUBMIT" id="new">Enter world of Techie Books
                </button>
